...
cat Introduction.md Design.md Requirements.md UserResearch.md UIDesign.md TechnicalResearch.md SystemArchitecture.md Implementation.md Testing.md Conclusion.md Appendix.md > sectionbuild.md
